...
from agent_interfaces import GreedyBaselineAgent, OpponentAwareSearchAgent, MultiAgentRLAgent
...
def make_agent(alg: str, mdp, layout, **gptargs):
    ...
    elif alg == "GreedyBaseline":
        agent = GreedyBaselineAgent(**gptargs)

    elif alg == "OpponentAwareSearch":
        agent = OpponentAwareSearchAgent(**gptargs)

    elif alg == "MultiAgentRL":
        agent = MultiAgentRLAgent(**gptargs)
