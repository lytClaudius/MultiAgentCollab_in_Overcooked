...
if __name__ == '__main__':
    ...
    parser.add_argument('--p0',  type=str, default='LLMPair', choices=['LLMPair', 'Human', 'Stay', 'Random', 'GreedyBaseline', 'OpponentAwareSearch', 'MultiAgentRL'], help='Algorithm for P0 agent 0')
    parser.add_argument('--p1', type=str, default='LLMPair', choices=['LLMPair', 'Human', 'Stay', 'Random', 'GreedyBaseline', 'OpponentAwareSearch', 'MultiAgentRL'], help='Algorithm for P1 agent 1')
